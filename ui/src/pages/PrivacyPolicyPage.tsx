  ...
  return (
    <div>
      <div id="md_en" data-target="out_en">
        ...
        <p>Last updated: August 06, 2020</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Greg and Ally's Recipe Book.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            By email: <a href="mailto:cenaacasaperdue@gmail.com">cenaacasaperdue@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
